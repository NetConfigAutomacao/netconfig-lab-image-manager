...
(function () {
  ...
  const translations = {
    pt: {
      ...
      'ui.tabs.vrnetlab': 'VRNETLAB',
      'ui.tabs.containerImages': 'Container Images',
      'ui.tabs.ishare2': 'iShare2',
      'ui.tabs.system': 'Sistema',
      'ui.eveIpLabel': 'IP do EVE-NG/PNETLab/ContainerLab',
      ...
      'ui.vrnetlab.aboutTitle': 'VRNETLAB para ContainerLab',
      'ui.vrnetlab.aboutText': 'VRNETLAB empacota appliances baseados em QEMU dentro de containers, permitindo usar imagens legadas no ContainerLab.',
      'ui.vrnetlab.statusBtn': 'Checar ambiente',
      'ui.vrnetlab.statusLoading': 'Consultando ambiente...',
      'ui.vrnetlab.statusHint': 'Consulta runtime de container e imagens com prefixo vrnetlab no host remoto.',
      'ui.vrnetlab.runtimeLabel': 'Runtime detectado',
      'ui.vrnetlab.runtimeHint': 'Procura por docker ou podman no host remoto.',
      'ui.vrnetlab.runtimeMissing': 'Nenhum runtime encontrado',
      'ui.vrnetlab.repoLabel': 'Repositório vrnetlab',
      'ui.vrnetlab.repoHint': 'Diretório padrão /opt/containerlab/vrnetlab quando presente.',
      'ui.vrnetlab.repoMissing': 'Não localizado',
      'ui.vrnetlab.installBtn': 'Instalar VRNETLAB',
      'ui.vrnetlab.installLoading': 'Instalando VRNETLAB...',
      'ui.vrnetlab.installHint': 'Se /opt/containerlab/vrnetlab não existe no host, será feito git clone do repositório oficial.',
      'ui.vrnetlab.imagesTitle': 'Imagens VRNETLAB',
      'ui.vrnetlab.imagesCount': '{count} imagem VRNETLAB|{count} imagens VRNETLAB',
      'ui.vrnetlab.imagesEmpty': 'Nenhuma imagem vrnetlab encontrada no runtime informado.',
      'ui.vrnetlab.imageUnknown': 'Imagem VRNETLAB',
      'vrnetlab.missingCreds': 'Preencha IP, usuário e senha do ContainerLab para usar o VRNETLAB.',
      'ui.containerImages.title': 'Imagens de container (docker/podman)',
      'ui.containerImages.hint': 'Lista imagens disponíveis no runtime (docker/podman) do host ContainerLab.',
      'ui.containerImages.loadBtn': 'Listar imagens',
      'ui.containerImages.loading': 'Listando...',
      'ui.containerImages.loadHint': 'Executa <code>docker images</code> (ou podman) no host remoto.',
      'ui.containerImages.listTitle': 'Imagens encontradas',
      'ui.containerImages.count': '{count} imagem|{count} imagens',
      'ui.containerImages.none': 'Nenhuma imagem encontrada.',
      'ui.containerImages.unnamed': 'Imagem sem nome',
      'container_images.missing_creds': 'Preencha IP, usuário e senha do ContainerLab.',
      ...
      'platform.containerlab': 'ContainerLab',
      'platform.unknown': 'Não identificado',
      'ui.system.platformLabel': 'Plataforma detectada',
      'ui.system.resourcesLabel': 'Recursos do servidor',
      'ui.system.resourcesTitle': 'Recursos do servidor',
      'ui.system.reload': 'Recarregar',
      'ui.system.reloadLoading': 'Recarregando...',
      'ui.system.cpu': 'CPU',
      'ui.system.ram': 'RAM',
      'ui.system.disk': 'DISCO',
      'ui.system.ramHint': 'Uso de memória',
      'ui.system.diskHint': 'Partição raiz',
      ...
      'images.deleteAction': 'Desinstalar',
      'images.deleteConfirm': 'Deseja remover a imagem {name} do tipo {type}?',
      'images.deleteSuccess': 'Imagem removida com sucesso.',
      'images.deleteFail': 'Falha ao remover a imagem.',
    ...
    en: {
      ...
      'ui.tabs.containerImages': 'Container Images',
      'ui.tabs.ishare2': 'iShare2',
      'ui.tabs.system': 'System',
      'ui.eveIpLabel': 'EVE-NG/PNETLab/ContainerLab IP',
      ...
      'ui.vrnetlab.aboutTitle': 'VRNETLAB for ContainerLab',
      'ui.vrnetlab.aboutText': 'VRNETLAB packages QEMU/KVM appliances into containers, enabling legacy images to run on ContainerLab.',
      'ui.vrnetlab.statusBtn': 'Check environment',
      'ui.vrnetlab.statusLoading': 'Checking environment...',
      'ui.vrnetlab.statusHint': 'Checks container runtime and images prefixed with vrnetlab on the remote host.',
      'ui.vrnetlab.runtimeLabel': 'Detected runtime',
      'ui.vrnetlab.runtimeHint': 'Looks for docker or podman on the remote host.',
      'ui.vrnetlab.runtimeMissing': 'No runtime found',
      'ui.vrnetlab.repoLabel': 'vrnetlab repository',
      'ui.vrnetlab.repoHint': 'Default path /opt/containerlab/vrnetlab when available.',
      'ui.vrnetlab.repoMissing': 'Not found',
      'ui.vrnetlab.installBtn': 'Install VRNETLAB',
      'ui.vrnetlab.installLoading': 'Installing VRNETLAB...',
      'ui.vrnetlab.installHint': 'If /opt/containerlab/vrnetlab is missing on the host, it will git clone the official repository.',
      'ui.vrnetlab.imagesTitle': 'VRNETLAB images',
      'ui.vrnetlab.imagesCount': '{count} VRNETLAB image|{count} VRNETLAB images',
      'ui.vrnetlab.imagesEmpty': 'No vrnetlab images were found on the detected runtime.',
      'ui.vrnetlab.imageUnknown': 'VRNETLAB image',
      'vrnetlab.missingCreds': 'Fill IP, user and password from the ContainerLab host to use VRNETLAB.',
      'ui.containerImages.title': 'Container images (docker/podman)',
      'ui.containerImages.hint': 'Lists images available on the host runtime (docker/podman).',
      'ui.containerImages.loadBtn': 'List images',
      'ui.containerImages.loading': 'Listing...',
      'ui.containerImages.loadHint': 'Runs <code>docker images</code> (or podman) on the remote host.',
      'ui.containerImages.listTitle': 'Found images',
      'ui.containerImages.count': '{count} image|{count} images',
      'ui.containerImages.none': 'No images found.',
      'ui.containerImages.unnamed': 'Unnamed image',
      'container_images.missing_creds': 'Fill IP, user and password for the ContainerLab host.',
      ...
      'ui.system.platformLabel': 'Detected platform',
      'ui.system.resourcesLabel': 'Server resources',
      'ui.system.resourcesTitle': 'Server resources',
      'ui.system.reload': 'Reload',
      'ui.system.reloadLoading': 'Reloading...',
      'ui.system.cpu': 'CPU',
      'ui.system.ram': 'RAM',
      'ui.system.disk': 'DISK',
      'ui.system.ramHint': 'Memory usage',
      'ui.system.diskHint': 'Root partition',
      ...
      'images.deleteAction': 'Uninstall',
      'images.deleteConfirm': 'Do you want to remove image {name} of type {type}?',
      'images.deleteSuccess': 'Image removed successfully.',
      'images.deleteFail': 'Failed to remove the image.',
    ...
    es: {
      ...
      'ui.tabs.ishare2': 'iShare2',
      'ui.tabs.system': 'Sistema',
      'ui.eveIpLabel': 'IP del EVE-NG/PNETLab/ContainerLab',
      ...
      'ui.ishare2.progressLabel': 'Instalando...',
      'ui.vrnetlab.aboutTitle': 'VRNETLAB para ContainerLab',
      'ui.vrnetlab.aboutText': 'VRNETLAB empaqueta appliances basados en QEMU dentro de contenedores para usarlos en ContainerLab.',
      'ui.vrnetlab.statusBtn': 'Verificar entorno',
      'ui.vrnetlab.statusLoading': 'Consultando entorno...',
      'ui.vrnetlab.statusHint': 'Consulta runtime de contenedores e imágenes con prefijo vrnetlab en el host remoto.',
      'ui.vrnetlab.runtimeLabel': 'Runtime detectado',
      'ui.vrnetlab.runtimeHint': 'Busca docker o podman en el host remoto.',
      'ui.vrnetlab.runtimeMissing': 'Ningún runtime encontrado',
      'ui.vrnetlab.repoLabel': 'Repositorio vrnetlab',
      'ui.vrnetlab.repoHint': 'Directorio por defecto /opt/containerlab/vrnetlab cuando existe.',
      'ui.vrnetlab.repoMissing': 'No localizado',
      'ui.vrnetlab.installBtn': 'Instalar VRNETLAB',
      'ui.vrnetlab.installLoading': 'Instalando VRNETLAB...',
      'ui.vrnetlab.installHint': 'Si /opt/containerlab/vrnetlab no existe en el host, se hará git clone del repositorio oficial.',
      'ui.vrnetlab.imagesTitle': 'Imágenes VRNETLAB',
      'ui.vrnetlab.imagesCount': '{count} imagen VRNETLAB|{count} imágenes VRNETLAB',
      'ui.vrnetlab.imagesEmpty': 'No se encontraron imágenes vrnetlab en el runtime detectado.',
      'ui.vrnetlab.imageUnknown': 'Imagen VRNETLAB',
      'vrnetlab.missingCreds': 'Completa IP, usuario y contraseña del ContainerLab para usar VRNETLAB.',
      'ui.containerImages.title': 'Imágenes de contenedor (docker/podman)',
      'ui.containerImages.hint': 'Lista imágenes disponibles en el runtime (docker/podman) del host ContainerLab.',
      'ui.containerImages.loadBtn': 'Listar imágenes',
      'ui.containerImages.loading': 'Listando...',
      'ui.containerImages.loadHint': 'Ejecuta <code>docker images</code> (o podman) en el host remoto.',
      'ui.containerImages.listTitle': 'Imágenes encontradas',
      'ui.containerImages.count': '{count} imagen|{count} imágenes',
      'ui.containerImages.none': 'No se encontraron imágenes.',
      'ui.containerImages.unnamed': 'Imagen sin nombre',
      'container_images.missing_creds': 'Completa IP, usuario y contraseña del ContainerLab.',
      ...
      'ui.system.platformLabel': 'Plataforma detectada',
      'ui.system.resourcesLabel': 'Recursos del servidor',
      'ui.system.resourcesTitle': 'Recursos del servidor',
      'ui.system.reload': 'Recargar',
      'ui.system.reloadLoading': 'Recargando...',
      'ui.system.cpu': 'CPU',
      'ui.system.ram': 'RAM',
      'ui.system.disk': 'DISCO',
      'ui.system.ramHint': 'Uso de memoria',
      'ui.system.diskHint': 'Partición raíz',
      'labels.target': 'Destino:',
      'labels.step': 'Etapa:',
      ...
      'images.deleteAction': 'Desinstalar',
      'images.deleteConfirm': '¿Deseas remover la imagen {name} del tipo {type}?',
      'images.deleteSuccess': 'Imagen removida con éxito.',
      'images.deleteFail': 'Fallo al remover la imagen.',
