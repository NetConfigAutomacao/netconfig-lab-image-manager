...
TRANSLATIONS = {
    "pt": {
        ...
        "ishare2.choose_missing": "Parâmetros 'job_id' e 'name' são obrigatórios.",
        "ishare2.choose_contact_error": "Falha ao contatar o serviço ishare2 para confirmar nome: {error}",
        "ishare2.choose_invalid_json": "Resposta inválida do serviço ishare2 (não é JSON) ao confirmar nome.",
        ...
        "vrnetlab.build.bad_vendor": "Vendor inválido.",
        ...
        "container_images.invalid_ref": "Referência de imagem inválida.",
        "container_images.pull_ok": "Imagem {image} baixada.",
        "container_images.pull_fail": "Falha ao baixar imagem (código {rc}).",
        "container_images.remove_ok": "Imagem {image} removida.",
        "container_images.remove_fail": "Falha ao remover imagem (código {rc}).",
        "container_labs.missing_creds": "Informe IP, usuário e senha do host ContainerLab.",
        "container_labs.missing_dir": "Diretório /opt/containerlab/labs não encontrado no host.",
        "container_labs.success": "Labs listados com sucesso.",
        "container_labs.fail": "Falha ao listar labs (código {rc}).",
        "container_labs.create_success": "Diretório /opt/containerlab/labs criado com sucesso.",
        "container_labs.create_fail": "Falha ao criar /opt/containerlab/labs (código {rc}).",
        "container_labs.empty": "Nenhum laboratório foi encontrado no diretório /opt/containerlab/labs.",
        "container_labs.invalid_lab": "Nome de lab inválido.",
        "container_labs.invalid_path": "Caminho inválido.",
        "container_labs.only_yaml": "Apenas arquivos .yml, .yaml, .txt ou .py podem ser editados.",
        "container_labs.lab_missing": "O lab '{name}' não foi encontrado.",
        "container_labs.file_missing": "Arquivo '{path}' não encontrado.",
        "container_labs.file_success": "Arquivo carregado com sucesso.",
        "container_labs.files_success": "Arquivos listados com sucesso.",
        "container_labs.empty_content": "Conteúdo vazio.",
        "container_labs.save_success": "Arquivo salvo com sucesso.",
        "container_labs.save_fail": "Falha ao salvar arquivo (código {rc}).",
        "container_labs.invalid_container": "Nome de container inválido.",
        "container_labs.missing_command": "Informe o comando a executar.",
        "container_labs.deploy_success": "Lab implantado com sucesso.",
        "container_labs.deploy_fail": "Falha ao implantar o lab (código {rc}).",
        "container_labs.destroy_success": "Lab destruído com sucesso.",
        "container_labs.destroy_fail": "Falha ao destruir o lab (código {rc}).",
        "container_labs.inspect_fail": "Falha ao inspecionar labs (código {rc}).",
        ...
        "container_labs.no_clab": "containerlab não encontrado no host.",
        "container_labs.tool_ok": "Comando executado com sucesso.",
        "container_labs.tool_fail": "Comando falhou (código {rc}).",
        "container_labs.tool_bad_input": "Parâmetros inválidos.",
        "container_labs.tool_no_dir": "Diretório do laboratório não encontrado no host.",
        "container_labs.inv_missing": "Inventário não encontrado (faça o deploy do lab primeiro).",
        "container_labs.drawio_missing": "Exportação drawio indisponível (plugin clab-io-draw ausente no host).",
    ...
    "en": {
        ...
        "ishare2.choose_missing": "Parameters 'job_id' and 'name' are required.",
        "ishare2.choose_contact_error": "Failed to contact the ishare2 service to confirm name: {error}",
        "ishare2.choose_invalid_json": "Invalid response from the ishare2 service (not JSON) when confirming name.",
        ...
        "vrnetlab.build.bad_vendor": "Invalid vendor.",
        ...
        "container_images.invalid_ref": "Invalid image reference.",
        "container_images.pull_ok": "Image {image} pulled.",
        "container_images.pull_fail": "Failed to pull image (exit code {rc}).",
        "container_images.remove_ok": "Image {image} removed.",
        "container_images.remove_fail": "Failed to remove image (exit code {rc}).",
        "container_labs.missing_creds": "Provide IP, user and password for the ContainerLab host.",
        "container_labs.missing_dir": "Directory /opt/containerlab/labs not found on the host.",
        "container_labs.success": "Labs listed successfully.",
        "container_labs.fail": "Failed to list labs (exit code {rc}).",
        "container_labs.create_success": "Directory /opt/containerlab/labs created successfully.",
        "container_labs.create_fail": "Failed to create /opt/containerlab/labs (exit code {rc}).",
        "container_labs.empty": "No laboratories were found in /opt/containerlab/labs.",
        "container_labs.invalid_lab": "Invalid lab name.",
        "container_labs.invalid_path": "Invalid path.",
        "container_labs.only_yaml": "Only .yml, .yaml, .txt or .py files can be edited.",
        "container_labs.lab_missing": "Lab '{name}' was not found.",
        "container_labs.file_missing": "File '{path}' not found.",
        "container_labs.file_success": "File loaded successfully.",
        "container_labs.files_success": "Files listed successfully.",
        "container_labs.empty_content": "Empty content.",
        "container_labs.save_success": "File saved successfully.",
        "container_labs.save_fail": "Failed to save file (exit code {rc}).",
        "container_labs.invalid_container": "Invalid container name.",
        "container_labs.missing_command": "Provide the command to run.",
        "container_labs.deploy_success": "Lab deployed successfully.",
        "container_labs.deploy_fail": "Failed to deploy the lab (exit code {rc}).",
        "container_labs.destroy_success": "Lab destroyed successfully.",
        "container_labs.destroy_fail": "Failed to destroy the lab (exit code {rc}).",
        "container_labs.inspect_fail": "Failed to inspect labs (exit code {rc}).",
        ...
        "container_labs.no_clab": "containerlab not found on the host.",
        "container_labs.tool_ok": "Command executed successfully.",
        "container_labs.tool_fail": "Command failed (exit code {rc}).",
        "container_labs.tool_bad_input": "Invalid parameters.",
        "container_labs.tool_no_dir": "Lab directory not found on the host.",
        "container_labs.inv_missing": "Inventory not found (deploy the lab first).",
        "container_labs.drawio_missing": "drawio export unavailable (clab-io-draw plugin missing on the host).",
    ...
    "es": {
        ...
        "ishare2.choose_missing": "Los parámetros 'job_id' y 'name' son obligatorios.",
        "ishare2.choose_contact_error": "Fallo al contactar el servicio ishare2 para confirmar el nombre: {error}",
        "ishare2.choose_invalid_json": "Respuesta inválida del servicio ishare2 (no es JSON) al confirmar el nombre.",
        ...
        "container_images.invalid_ref": "Referencia de imagen inválida.",
        "container_images.pull_ok": "Imagen {image} descargada.",
        "container_images.pull_fail": "Fallo al descargar imagen (código {rc}).",
        "container_images.remove_ok": "Imagen {image} eliminada.",
        "container_images.remove_fail": "Fallo al eliminar imagen (código {rc}).",
        "container_labs.missing_creds": "Informa IP, usuario y contraseña del host ContainerLab.",
        "container_labs.missing_dir": "Directorio /opt/containerlab/labs no encontrado en el host.",
        "container_labs.success": "Labs listados con éxito.",
        "container_labs.fail": "Fallo al listar labs (código {rc}).",
        "container_labs.create_success": "Directorio /opt/containerlab/labs creado con éxito.",
        "container_labs.create_fail": "Fallo al crear /opt/containerlab/labs (código {rc}).",
        "container_labs.empty": "No se encontraron laboratorios en /opt/containerlab/labs.",
        "container_labs.invalid_lab": "Nombre de lab inválido.",
        "container_labs.invalid_path": "Ruta inválida.",
        "container_labs.only_yaml": "Solo se pueden editar archivos .yml, .yaml, .txt o .py.",
        "container_labs.lab_missing": "El lab '{name}' no fue encontrado.",
        "container_labs.file_missing": "Archivo '{path}' no encontrado.",
        "container_labs.file_success": "Archivo cargado con éxito.",
        "container_labs.files_success": "Archivos listados con éxito.",
        "container_labs.empty_content": "Contenido vacío.",
        "container_labs.save_success": "Archivo guardado con éxito.",
        "container_labs.save_fail": "Fallo al guardar el archivo (código {rc}).",
        "container_labs.invalid_container": "Nombre de contenedor inválido.",
        "container_labs.missing_command": "Indica el comando a ejecutar.",
        "container_labs.deploy_success": "Lab desplegado con éxito.",
        "container_labs.deploy_fail": "Fallo al desplegar el lab (código {rc}).",
        "container_labs.destroy_success": "Lab destruido con éxito.",
        "container_labs.destroy_fail": "Fallo al destruir el lab (código {rc}).",
        "container_labs.inspect_fail": "Fallo al inspeccionar labs (código {rc}).",
        ...
        "container_labs.no_clab": "containerlab no encontrado en el host.",
        "container_labs.tool_ok": "Comando ejecutado con éxito.",
        "container_labs.tool_fail": "El comando falló (código {rc}).",
        "container_labs.tool_bad_input": "Parámetros inválidos.",
        "container_labs.tool_no_dir": "Directorio del laboratorio no encontrado en el host.",
        "container_labs.inv_missing": "Inventario no encontrado (despliega el lab primero).",
        "container_labs.drawio_missing": "Exportación drawio no disponible (falta el plugin clab-io-draw en el host).",
