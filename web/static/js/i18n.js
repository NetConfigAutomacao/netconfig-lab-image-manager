...
(function () {
  ...
  const translations = {
    pt: {
      ...
      'ui.vrnetlab.repoHint': 'Diretório padrão /opt/vrnetlab quando presente.',
      ...
      'ui.vrnetlab.installHint': 'Se /opt/vrnetlab não existe no host, será feito git clone do repositório oficial.',
    ...
    en: {
      ...
      'ui.vrnetlab.repoHint': 'Default path /opt/vrnetlab when available.',
      'ui.vrnetlab.repoMissing': 'Not found',
      'ui.vrnetlab.installBtn': 'Install VRNETLAB',
      'ui.vrnetlab.installLoading': 'Installing VRNETLAB...',
      'ui.vrnetlab.installHint': 'If /opt/vrnetlab is missing on the host, it will git clone the official repository.',
    ...
    es: {
      ...
      'ui.vrnetlab.repoHint': 'Directorio por defecto /opt/vrnetlab cuando existe.',
      'ui.vrnetlab.repoMissing': 'No localizado',
      'ui.vrnetlab.installBtn': 'Instalar VRNETLAB',
      'ui.vrnetlab.installLoading': 'Instalando VRNETLAB...',
      'ui.vrnetlab.installHint': 'Si /opt/vrnetlab no existe en el host, se hará git clone del repositorio oficial.',
