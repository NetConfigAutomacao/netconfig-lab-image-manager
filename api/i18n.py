...
TRANSLATIONS = {
    "pt": {
        ...
        "vrnetlab.status.no_repo": "Repositório /opt/containerlab/vrnetlab não encontrado. Você pode instalá-lo pelo botão abaixo.",
        "vrnetlab.status.fail": "Falha ao consultar VRNETLAB (código {rc}).",
        "vrnetlab.install.success": "VRNETLAB instalado em /opt/containerlab/vrnetlab.",
        "vrnetlab.install.already": "VRNETLAB já está presente no host.",
        ...
        "container_images.missing_creds": "Informe IP, usuário e senha do host ContainerLab.",
        "container_images.no_runtime": "Runtime de containers (docker/podman) não encontrado para listar as imagens.",
        "container_images.success": "Imagens de container listadas com sucesso.",
        "container_images.fail": "Falha ao listar imagens de container (código {rc}).",
    },
    "en": {
        ...
        "vrnetlab.status.no_repo": "Repository /opt/containerlab/vrnetlab not found. You can install it using the button below.",
        "vrnetlab.status.fail": "Failed to query VRNETLAB (exit code {rc}).",
        "vrnetlab.install.success": "VRNETLAB installed at /opt/containerlab/vrnetlab.",
        "vrnetlab.install.already": "VRNETLAB is already present on the host.",
        ...
        "container_images.missing_creds": "Provide IP, user and password for the ContainerLab host.",
        "container_images.no_runtime": "Container runtime (docker/podman) not found to list images.",
        "container_images.success": "Container images listed successfully.",
        "container_images.fail": "Failed to list container images (exit code {rc}).",
    },
    "es": {
        ...
        "vrnetlab.status.no_repo": "Repositorio /opt/containerlab/vrnetlab no encontrado. Puedes instalarlo con el botón abajo.",
        "vrnetlab.status.fail": "Fallo al consultar VRNETLAB (código {rc}).",
        "vrnetlab.install.success": "VRNETLAB instalado en /opt/containerlab/vrnetlab.",
        "vrnetlab.install.already": "VRNETLAB ya está presente en el host.",
        ...
        "container_images.missing_creds": "Informa IP, usuario y contraseña del host ContainerLab.",
        "container_images.no_runtime": "Runtime de contenedores (docker/podman) no encontrado para listar imágenes.",
        "container_images.success": "Imágenes de contenedores listadas con éxito.",
        "container_images.fail": "Fallo al listar imágenes de contenedor (código {rc}).",
    },
}
